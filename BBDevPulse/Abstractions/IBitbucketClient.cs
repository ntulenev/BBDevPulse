...
internal interface IBitbucketClient
{
    ...
    /// <summary>
    /// Fetches pull request commits.
    /// </summary>
    /// <param name="workspace">Workspace identifier.</param>
    /// <param name="repoSlug">Repository slug.</param>
    /// <param name="pullRequestId">Pull request identifier.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Commit information for the pull request.</returns>
    IAsyncEnumerable<PullRequestCommitInfo> GetPullRequestCommitsAsync(
        Workspace workspace,
        RepoSlug repoSlug,
        PullRequestId pullRequestId,
        CancellationToken cancellationToken);
    ...
    /// <summary>
    /// Fetches aggregated commit size from diffstat.
    /// </summary>
    /// <param name="workspace">Workspace identifier.</param>
    /// <param name="repoSlug">Repository slug.</param>
    /// <param name="commitHash">Commit hash.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Aggregated commit size summary.</returns>
    Task<PullRequestSizeSummary> GetCommitSizeAsync(
        Workspace workspace,
        RepoSlug repoSlug,
        string commitHash,
        CancellationToken cancellationToken);
